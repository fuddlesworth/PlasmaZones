...
UpdateShaderParamsCommand::UpdateShaderParamsCommand(QPointer<EditorController> editorController,
                                                     ...
                                                     QUndoCommand* parent)
    : QUndoCommand(text.isEmpty() ? PI18n::tr("Change Shader Parameter", "@action") : text, parent)
...
UpdateShaderParamsCommand::UpdateShaderParamsCommand(QPointer<EditorController> editorController,
    ...
    : QUndoCommand(text.isEmpty() ? PI18n::tr("Change Shader Parameters", "@action") : text, parent)
    , m_editorController(editorController)
