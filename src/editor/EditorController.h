...
public:
    ...
    // layouts via an in-process PhosphorZones::LayoutManager + PhosphorZones::ZonesLayoutSource so QML
...
public Q_SLOTS:
    ...
    // PropertyChanged). Forces an in-process PhosphorZones::LayoutManager reload so
...
private:
    ...
    /// PhosphorZones::LayoutManager once.
