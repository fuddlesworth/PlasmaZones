...
private:
     ...
     * disabled a monitor / virtual desktop / activity. Selects the mode via
     * the ScreenModeRouter when wired; falls back to Snapping mode otherwise
     * (consistent with the snap-side write gate). Empty screenId is treated
