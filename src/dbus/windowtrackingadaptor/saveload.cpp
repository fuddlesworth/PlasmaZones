...
void WindowTrackingAdaptor::saveStateOnShutdown()
{
    ...
    // PhosphorZones::LayoutManager destruction can trigger activeLayoutChanged → onLayoutChanged()
...
void WindowTrackingAdaptor::scheduleSaveState()
{
    ...
    // PhosphorZones::LayoutManager teardown can trigger onLayoutChanged() → scheduleSaveState()
