...
#undef REGISTER_PER_MODE_DISABLE
    ...
    if (concrete) {
        ...
        REGISTER_CONCRETE_STRING("cycleColumnWidthShortcut", cycleColumnWidthShortcut, setCycleColumnWidthShortcut)
        ...
        REGISTER_CONCRETE_STRING("toggleCenterFocusedColumnShortcut", toggleCenterFocusedColumnShortcut,
                                 setToggleCenterFocusedColumnShortcut)
