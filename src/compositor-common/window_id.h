...
/**
 * @brief Compositor-agnostic window ID utility functions
 *
 * These string utilities operate on window IDs in the format "appId|instanceId"
 * and are shared by all compositor plugins.
 */
