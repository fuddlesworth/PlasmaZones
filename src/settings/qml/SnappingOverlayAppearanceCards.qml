...
// Appearance section of Snapping → Overlay: how the drag-time zone overlay LOOKS
// (zone colours, opacity, borders, labels, effects, shaders). Extracted from the
// page so SnappingOverlayPage stays under the file-size cap; the page drops this
// in after the overlay behavior cards. Binds two controllers: snappingZonesPage
// (colour import + border/label bounds) and snappingEffectsPage (shader/audio
// bounds + CAVA).
ColumnLayout {
    id: root
    ...
    // =====================================================================
    // COLOR DIALOGS (non-visual; ignored by the layout)
    // =====================================================================
    ColorDialog {
