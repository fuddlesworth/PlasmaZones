...
ShaderSetsPage {
    ...
    infoBannerText: i18n("Overlay sets bundle your zone overlay shader assignments into one shareable JSON file. Applying a set merges into your current assignments. Layouts it doesn't cover are left unchanged.")
    saveDescription: i18n("Capture the global default and every per-layout override as a named overlay set.")
    importDescription: i18n("Overlay sets are single JSON files under your data directory. Drop a set file here to import it, or use the buttons below.")
    emptyStateText: i18n("No overlay sets saved yet.")
    nameFieldAccessibleName: i18n("Overlay set name")
    descriptionFieldAccessibleName: i18n("Overlay set description")
