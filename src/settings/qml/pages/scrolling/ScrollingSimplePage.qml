        ...
        SettingsCard {
            ...
            contentItem: ColumnLayout {
                ...
                SettingsRow {
                    ...
                    description: i18n("Which entry of the column width presets a new column opens at, counted from 1. On a screen with a layout template the number counts into the template's widths instead.")
