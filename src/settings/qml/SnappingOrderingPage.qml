...
Flickable {
    ...
    readonly property bool hasCustomOrder: settingsController.settings.snappingLayoutOrder.length > 0

    function rebuildModel() {
        orderModel.clear();
        let items = settingsController.resolvedSnappingOrder();
    ...
    function commitOrder() {
        ...
        settingsController.settings.snappingLayoutOrder = ids;
    }
    ...
    ColumnLayout {
        ...
        Kirigami.InlineMessage {
            ...
            text: i18n("Set the priority order for layouts when cycling with keyboard shortcuts and in the zone selector popup. Drag rows or use the arrow buttons to reorder.")
            visible: true
        }
            ...
            contentItem: ColumnLayout {
                ...
                Item {
                        ...
                        delegate: Item {
                            ...
                            Rectangle {
                                ...
                                RowLayout {
                                    ...
                                    // Zone preview (same style as the dropdown)
                                    Rectangle {
                                        ...
                                        QFZCommon.ZonePreview {
                                            ...
                                            zones: delegateRoot.model.zones || []
                                    ...
                                    // Zone count badge
                                    Rectangle {
                                        Layout.preferredWidth: zoneLabel.implicitWidth + Kirigami.Units.smallSpacing * 2
                                        Layout.preferredHeight: zoneLabel.implicitHeight + Kirigami.Units.smallSpacing
                                        radius: height / 2
                                        ...
                                        Label {
                                            ...
                                            text: i18np("%n zone", "%n zones", delegateRoot.model.zoneCount)
                                            font: Kirigami.Theme.smallFont
                                    ...
                                    ToolButton {
                                        ...
                                        onClicked: settingsController.moveSnappingLayout(delegateRoot.index, delegateRoot.index - 1)
                    ...
                    Kirigami.PlaceholderMessage {
                        ...
                        explanation: i18n("Create layouts in the Layouts page first.")
                    }
                ...
                RowLayout {
                    ...
                    Button {
                        ...
                        onClicked: settingsController.resetSnappingOrder()
                        Accessible.name: i18n("Reset layout order to default")
                    }
