...
Item {
    ...
    // RuleRow has reported its implicitHeight back. Matches the
    ...
    Repeater {
        ...
        delegate: Item {
            ...
            // against RuleRow.implicitHeight), and the
            ...
            Accessible.name: i18nc("Accessible row label for a rule", "Rule %1 of %2: %3", delegateRoot.index + 1, root.rules.length, delegateRoot.modelData.name)
            ...
            RowLayout {
                ...
                RuleRow {
                    ...
                    // self-referential cycle. RuleRow's own
