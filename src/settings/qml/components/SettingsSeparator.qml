 ...
 */
Kirigami.Separator {
    /// Advanced-mode tier, mirroring SettingsRow.advancedOnly. Give a
    /// separator the SAME advancedOnly (and enabled) condition as the row it
    /// adjoins so the pair collapses together.
