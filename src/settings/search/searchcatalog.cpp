...
void seedSearchCatalog(PhosphorControl::SearchController* search)
{
    ...
    addSetting(search, QStringLiteral("scrolling-window"), QStringLiteral("scrollingKeepFloatingAbove"),
               PhosphorI18n::tr("Keep floating windows above"),
               {PhosphorI18n::tr("float"), PhosphorI18n::tr("above"), PhosphorI18n::tr("stacking"),
                PhosphorI18n::tr("layer")});
    ...
    addSetting(search, QStringLiteral("scrolling-window"), QStringLiteral("scrollingFocusFollowsMouseMaxScroll"),
               ...
               {PhosphorI18n::tr("focus"), PhosphorI18n::tr("mouse"), PhosphorI18n::tr("hover"),
                PhosphorI18n::tr("scroll"), PhosphorI18n::tr("limit"), PhosphorI18n::tr("strip"),
                PhosphorI18n::tr("cap")});
    ...
    addSetting(search, QStringLiteral("scrolling-window"), QStringLiteral("wheelFocusTriggers"),
               PhosphorI18n::tr("Scroll key for column focus"),
               {PhosphorI18n::tr("scroll key"), PhosphorI18n::tr("wheel"), PhosphorI18n::tr("trigger"),
                PhosphorI18n::tr("modifier"), PhosphorI18n::tr("focus")});
    addSetting(search, QStringLiteral("scrolling-window"), QStringLiteral("wheelViewTriggers"),
               PhosphorI18n::tr("Scroll key for the view"),
               {PhosphorI18n::tr("scroll key"), PhosphorI18n::tr("wheel"), PhosphorI18n::tr("trigger"),
                PhosphorI18n::tr("modifier"), PhosphorI18n::tr("view"), PhosphorI18n::tr("pan")});
