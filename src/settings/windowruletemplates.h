...
namespace PlasmaZones::WindowRuleTemplates {
...
/// drag-to-reorder is meaningful. Shared with `WindowRuleController`'s
...
/// `WindowRuleController::newEmptyRule` for the subject contract — the
