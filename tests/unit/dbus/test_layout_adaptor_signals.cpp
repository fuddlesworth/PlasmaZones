...
namespace {
class ReferenceScreens final : public PhosphorScreens::IScreenProvider
{
public:
...
private Q_SLOTS:
    ...
    void testScreenStatesCarryLiveLayoutCapabilities()
    {
        ...
        PhosphorScreens::ScreenManager screens({.screenProvider = &provider, .useGeometrySensors = false});
        screens.start();
