...
- SPDX header on every .luau file: `plasmazones/data/algorithms/**` is GPL-3.0-or-later; Luau living inside `phosphor-libs/libs/phosphor-*` follows the library (LGPL-2.1-or-later).
