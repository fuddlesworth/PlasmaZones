...
- Licensing: top-level `plasmazones/tests/**` is GPL-3.0-or-later, but `phosphor/libs/phosphor-*/tests/**` follows the library (LGPL-2.1-or-later). A GPL header inside a phosphor lib's tests is a finding.
