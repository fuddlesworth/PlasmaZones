...
`plasmazones/data/schemas/shader-metadata.schema.json`; `plasmazones/data/surface/shared/surface_uniforms.glsl`,
...
`plasmazones/data/schemas/surface-metadata.schema.json`. Read the two shared headers before writing.
