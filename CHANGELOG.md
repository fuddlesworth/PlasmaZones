...
- **Backdrop panes can round their bottom corners or leave them square, and their edge feather is adjustable**: all eight Blur-category packs gained a "Round bottom corners" switch, on by default, which you turn off to round only the top two. They also gained an "Edge softness" value for the anti-alias feather of the pane edge. ([#1123](https://github.com/fuddlesworth/PlasmaZones/pull/1123))
