...
- **An unfocused Audio Border was dimmer than its own setting asked for**: the focus cue was applied twice, so the pack rendered at 55% of the alpha its focus parameter specified. ([#1123](https://github.com/fuddlesworth/PlasmaZones/pull/1123))
