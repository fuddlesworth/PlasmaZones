...
- **What's New dialog**: the settings app ships a What's New dialog driven by `data/whatsnew.json`, opened on first launch after an upgrade or on demand from the About page.
