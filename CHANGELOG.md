...
- **Exporting or importing your settings said nothing at all**: the file picker closed and you were left to guess, whether it had worked or failed on a path it would not write to, a file that was not a settings file, or a backup it could not take. Both now confirm when they succeed and say what went wrong when they don't ([#779](https://github.com/fuddlesworth/PlasmaZones/pull/779)).
