...
- **Brazilian Portuguese translation**: PlasmaZones is now fully translated into Brazilian Portuguese, covering the daemon, the layout editor, the settings app and the KCM. All 3973 strings are filled, including the plural forms and the settings search keywords, so the interface reads in Portuguese wherever your locale is set to pt_BR.
