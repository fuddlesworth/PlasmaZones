...
- **The zone overlay no longer leaves an old zone lit**: on the first activation of a drag, the zone you had just left stayed highlighted alongside the one under the cursor, so two zones looked like the drop target at once. Releasing the trigger and activating again cleared it. The highlight now clears the moment the cursor moves to another zone.
