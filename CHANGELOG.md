...
- **The daemon and the KWin effect must be the same build**: this release changes the message they speak again, so a mismatched pair refuses to connect rather than misbehaving. Packagers should rebuild and ship both together ([#1030](https://github.com/fuddlesworth/PlasmaZones/pull/1030)).
