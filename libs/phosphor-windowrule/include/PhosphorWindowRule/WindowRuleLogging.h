...
// inline bridges in ContextRuleBridge.h, AnimationAppRuleBridge.h, ...) can
// emit warnings through the same `org.phosphor.windowrule.*` channels the
...
PHOSPHORWINDOWRULE_EXPORT Q_DECLARE_LOGGING_CATEGORY(lcWindowRule) PHOSPHORWINDOWRULE_EXPORT
