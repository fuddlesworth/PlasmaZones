...
// Shared concise constructors for the phosphor-rules test suite. Header
...
namespace PhosphorRules::TestHelpers {
...
inline Rule makeRule(const QString& name, int priority, const MatchExpression& match, const QList<RuleAction>& actions)
{
    Rule r;
