...
struct PHOSPHORSHELL_EXPORT Cell
{
    ...
    int zoneNumber = 0;
    /// Tiling monocle only: how many windows share this rect. 1 otherwise.
    int stack = 1;
};
...
/// The scrolling parse: the visible tiles as cells plus the lens band.
 ...
 * That is the documented fallback until the strip model is exposed.
 */
