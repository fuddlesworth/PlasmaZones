...
// code (for the get_popup request). PhosphorWayland never uses layer shell
...
// get_popup request, but PhosphorWayland never calls get_popup.
//
...
// This is intentional — PhosphorWayland never creates layer-shell popups, so
