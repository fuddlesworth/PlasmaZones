 ...
 *        output. In-layout zone-adjacency and virtual-screen-swap callers
 *        leave it false (default) so an offset-but-present neighbour still
 *        resolves — a swap targets whatever region occupies that direction,
 *        diagonal or not.
 *
