...
/// Register every PhosphorServiceBluetooth QML type under the
/// `Phosphor.Service.Bluetooth` module at version 1.0. Idempotent on
...
/// expose BlueZ to its QML can call this) before any `QQmlEngine`
...
PHOSPHORSERVICEBLUETOOTH_EXPORT void registerQmlTypes();
