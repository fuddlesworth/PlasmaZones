 ...
 *
 * Issues are produced by @ref WindowRule::validationIssues — distinct from the
 ...
 */
struct PHOSPHORWINDOWRULES_EXPORT ValidationIssue
{
 ...
 */
struct PHOSPHORWINDOWRULES_EXPORT WindowRule
{
    QUuid id;
    QString name;
    bool enabled = true;
