...
// SurfaceShaderItem comes from this file's own module (org.phosphor.surface),
// so a host that links the module's plugin gets both this host and its stage
// type together. The self-import is what makes the stage type resolve when
// this file is loaded from the module.
