...
Luau is vendored as a committed source tarball (`phosphor-libs/extern/luau-<ver>.tar.gz`,
...
- `QtCore`, `Threads`
- Vendored Luau (`phosphor-libs/extern/luau-*.tar.gz`), or a system Luau via `-DPLASMAZONES_SYSTEM_LUAU=ON`
