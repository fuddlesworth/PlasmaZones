...
/// by the `static_assert` in `phosphor-libs/libs/phosphor-animation/src/contract_pins.cpp`.
///
...
// phosphor-libs/libs/phosphor-animation/src/contract_pins.cpp. It cannot live in this header
