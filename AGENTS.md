# PlasmaZones — Codex Configuration
...
`README.md` is deliberately OUT of scope, along with the other developer-facing repo docs (`AGENTS.md`, `docs/**`, `tools/**/README.md`). The README uses em-dashes structurally throughout and pulling it under this rule would need a full punctuation rewrite first. Do not "fix" README em-dashes to satisfy the bullets below.
