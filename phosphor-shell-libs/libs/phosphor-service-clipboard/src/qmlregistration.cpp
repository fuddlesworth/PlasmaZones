...
constexpr const char* kModule = "Phosphor.Service.Clipboard";
} // namespace
...
void registerQmlTypes()
{
    ...
    std::call_once(once, [] {
        // Instantiable host. The shell constructs the service in QML and binds
        // its history model; a plain type, NOT a singleton.
        qmlRegisterType<ClipboardService>(kModule, kModuleVersionMajor, kModuleVersionMinor, "ClipboardService");
    });
}
