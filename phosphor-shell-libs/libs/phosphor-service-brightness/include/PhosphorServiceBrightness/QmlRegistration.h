...
/// Register every PhosphorServiceBrightness QML type under the
/// `Phosphor.Service.Brightness` module at version 1.0. Idempotent on repeat
...
///
/// Called from the consuming binary (typically `phosphor-shell/src/main.cpp`) before
...
PHOSPHORSERVICEBRIGHTNESS_EXPORT void registerQmlTypes();
