...
#define glowR            customParams[1].y
#define glowG            customParams[1].z
#define glowB            customParams[1].w
#define glowA            customParams[2].x
#define lineR            customParams[2].y
#define lineG            customParams[2].z
