...
private Q_SLOTS:
    ...
    void testSaveLoad_twoScreenConfig()
    {
        ...
        Settings settings;
        PhosphorScreens::VirtualScreenConfig loaded = settings.virtualScreenConfig(physId);

        QCOMPARE(loaded.physicalScreenId, physId);
        QCOMPARE(loaded.screens.size(), 2);

        // Left screen
        const PhosphorScreens::VirtualScreenDef& left = loaded.screens[0];
        ...
        // Right screen
        const PhosphorScreens::VirtualScreenDef& right = loaded.screens[1];
    ...
    void testSaveLoad_emptyConfig_removesExisting()
    {
        ...
        {
            Settings settings;
            PhosphorScreens::VirtualScreenConfig empty;
    ...
    void testSaveLoad_multiplePhysicalScreens()
    {
        ...
        Settings settings;
        PhosphorScreens::VirtualScreenConfig loaded1 = settings.virtualScreenConfig(physId1);
        PhosphorScreens::VirtualScreenConfig loaded2 = settings.virtualScreenConfig(physId2);
    ...
    void testVirtualScreenConfigs_returnsAllConfigs()
    {
        ...
        QHash<QString, PhosphorScreens::VirtualScreenConfig> all = settings.virtualScreenConfigs();
        QCOMPARE(all.size(), 2);
    ...
    void testSetVirtualScreenConfigs_replacesAll()
    {
        ...
        QHash<QString, PhosphorScreens::VirtualScreenConfig> newConfigs;
    ...
    void testSetVirtualScreenConfig_returnsFalseOnInvalid()
    {
        ...
        PhosphorScreens::VirtualScreenConfig bad;
