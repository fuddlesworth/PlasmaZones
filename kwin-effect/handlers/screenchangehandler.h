...
private:
    ...
    /// keep-windows-in-zones repair after a resolution change). Returns
    /// nothing for scrolling windows — the scrolling fullscreen-exit
    /// repair goes through Scrolling.reapplyWindowGeometry instead.
