...
/// SurfaceMultipassState (the per-window GL state for the decoration composite
/// fold) lives in surface_state.h — split out to keep this header under the
/// 800-line limit. Included above so every existing consumer of types.h keeps
/// seeing it.
